...
const ModalForm = (props) => {
    ...
    const {mutate, isLoading, isIdle, isPaused} = useMutation({
        mutationFn: formData => PostService.sendMail(formData)
    })
    ...
    return (
        <div className={classes.wrapper} {...props}>
            ...
            <div className={classes.svgBtn} onClick={() => exit()}>
                <svg className={classes.svg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="25px"
                     height="25px">
                    <path
